...
public class Rectangle {
	...
	/**
	 * Creates a new instance of Rectangle at position (x, y) and with predefine
	 * dimension
	 * 
	 * @param x
	 ...
	 * specified location (rX, rY) with the specified dimensions (rWidth,
	 * rHeight).
	 * 
	 * @param rX
	 ...
	 * @param rHeight
	 *            the height of the Rectangle
	 * @return true if the Rectangle specified by (rX, rY, rWidth, rHeight) is
	 ...
	 * @param rY
	 *            the specified y coordinate
	 * @return true if the point (rX, rY) is inside this Rectangle; false
	 *         otherwise.
	 */
	...
	/**
	 * Returns a rectangle that intersects the given rectangle with this
	 * rectangle
	 * 
	 * @param rX
	 ...
	 * 
	 * @param tx
	 *            x of first rectangle
	 * @param ty
	 *            y of first rectangle
	 * @param tw
	 *            width of first rectangle
	 * @param th
	 *            height of first rectangle
	 * @param x
	 *            x of second rectangle
	 * @param y
	 *            y of second rectangle
	 * @param width
