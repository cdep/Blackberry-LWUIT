...
/**
 * The action placed on the soft buttons and in the Menu on devices, similar to
 * the MIDP command abstraction and Swing's Actions. Unlike the MIDP abstraction
 * this class can be derived to implement the right behavior
 * 
 * @author Nir Shabi
 */
public class Command implements ActionListener {
	...
	/**
	 * Simplifies code dealing with commands allowing them to be used in switch
	 ...
	 *            the string that will be placed on the Soft buttons\Menu
	 * @param id
	 *            user defined ID for a command simplifying switch statement
	 *            code working with a command
	 */
	...
	/**
	 * The client properties are a useful way to associate meta-data with a
	 * command without subclassing
	 * 
	 * @param key
