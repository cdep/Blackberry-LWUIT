...
/**
 * The tree component allows constructing simple tree component hierechies that
 * can be expaneded seamingly with no limit. The tree is bound to a model that
 * can provide data with free form depth such as file system or similarly
 * structured data. To customize the look of the tree the component can be
 * derived and component creation can be replaced.
 * 
 * @author Shai Almog
 */
public class Tree extends Container {
	 ...
	 * 
	 * @param node
	 *            the node object from the model to display on the button
	 * @param depth
	 *            the depth within the tree (normally represented by indenting
	 *            the entry)
	...
	protected Dimension calcPreferredSize() {
		...
		// if the tree is entirely collapsed try to reserve at least 6 rows for
		// the content
