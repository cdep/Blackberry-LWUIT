...
/**
 * Uses the google REST search result API and parses the results for
 * manipulation by an application. http://code.google.com/apis/ajaxsearch/
 * Returns via the action event a vector containing entries of
 * GoogleRESTService.ResultEntry. Please make sure to abide by the terms of use
 * http://code.google.com/apis/ajaxsearch/terms.html and obtain an API key
...
public class GoogleRESTService extends ConnectionRequest implements JSONParseCallback {
	...
	/**
	 * The constructor accepts the search query to send to google defaulting to
	 * web search
	 * 
	 * @param query
	 ...
	 *            the query sent to google
	 * @param requestType
	 *            one of the constant search values defined e.g. WEB_SEARCH,
	 *            VIDEO_SEARCH, BLOG_SEARCH, LOCAL_SEARCH etc.
	 */
	...
	/**
	 * Sets the Google API key for this request see
	 * http://code.google.com/apis/ajaxsearch/key.html
	 * 
	 * @param key
	 *            google API key
	 ...
	 * 
	 * @param type
	 *            SAFE_SEARCH_OFF, SAFE_SEARCH_MODERATE, SAFE_SEARCH_ACTIVE
	 */
	...
	/**
	 * Sets the default Google API key see
	 * http://code.google.com/apis/ajaxsearch/key.html
	 * 
	 * @param key
	 *            google API key
	...
	/**
	 * Class representing the results from the request, for details of the
	 * various attribute values please follow the class references at:
	 * http://code
	 * .google.com/apis/ajaxsearch/documentation/reference.html#_restUrlBase
	 */
	public static class ResultEntry {
		 ...
		 *            the estimatedResultCount to set
		 */
