...
public class RSSService extends ConnectionRequest implements ParserCallback {
	 ...
	 *            the limit on the number of RSS entries supported
	 * @param startOffset
	 *            indicates the entry offset which we are interested in, this is
	...
	/**
	 * Indicates whether more entries might be available since the limt might
	 * have been reached
	 * 
	 * @return the hasMore
	 */
	 ...
	 * which effectively contains a plain text version of the description tag.
	 * 
	 * @param createPlainTextDetails
	 *            the createPlainTextDetails to set
	 */
