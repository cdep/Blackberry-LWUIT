 ...
 * This class can be replaced to implement various supported device types and
 * hide device bugs
 * 
 * @author Shai Almog
 */
public abstract class IOImplementation {
	...
	/**
	 * Connects to a given URL, returns a connection object to be used with the
	 * implementation later
	 * 
	 * @param url
	 *            the URL to connect to
	 * @param read
	 *            indicates wheher the connection will be read from
	 * @param write
	 *            indicates whether writing will ocurre into the connection
	 ...
	 * 
	 * @param connection
	 *            the connection to open an output stream on
	 * @return the created output stream
	 * @throws IOException
	 *             thrown by underlying implemnetation
	 */
	 ...
	 * 
	 * @param connection
	 *            the connection to open an input stream on
	 ...
	 * 
	 * @param file
	 *            the file to which we should open a stream
	 * @return the created output stream
	 * @throws IOException
	 *             thrown by underlying implemnetation
	 */
	...
	/**
	 * Returns the HTTP response header fields, returns optionally more than one
	 * result or null if no field is present.
	 * 
	 * @param name
	 *            field name for http header
	 * @param connection
	...
	/**
	 * Indicates whether the underlying implementation supports the notion of a
	 * network operation timeout. If not timeout is "faked"
	 * 
	...
	/**
	 * The storage data is used by some storage implementations (e.g. CDC) to
	 * place the storage object in a "proper" location matching the application
	 * name. This needs to be set by the user, the name might be ignored in
	 * platforms (such as MIDP) where storage is mapped to a native application
	 * specific storage.
	 * 
	 * @param storageData
	 *            the name for the storage or its context
	 */
	...
	/**
	 * Renames a file to the given name, expects the new name to be relative to
	...
	/**
	 * For some reason the standard code for writing UTF8 output in a server
	 * request doesn't work as expected on SE/CDC stacks.
	 * 
	...
	/**
	 * Some devices need more elaborate thread creation logic e.g. to increase
	 * the default stack size or might use a pooling strategy
	 * 
	 * @param name
	...
	/**
	 * Allows binding logic to occur before closing the output stream such as
	 * syncing
	 * 
	 * @param s
	 *            the closing stream
	...
	/**
	 * This method is useful strictly for debugging, the logger can use it to
	 * track file opening/closing thus detecting potential file resource leaks
	 * that can cause serious problems in some OS's.
	 * 
	 * @param al
	 *            action listener to receive the callback
	 */
	 ...
	 * @param isInput
	 *            whether the stream is an input or output stream
	 * @param count
	 *            the number of streams of this type
	 */
