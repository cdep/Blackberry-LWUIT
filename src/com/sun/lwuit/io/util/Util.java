...
public class Util {
	...
	/**
	 * Fix for RFE 427: http://java.net/jira/browse/LWUIT-427 Allows determining
	 * chars that should not be encoded
	 */
	 ...
	 *            destination
	 * @param bufferSize
	 *            the size of the buffer, which should be a power of 2 large
	 *            enoguh
	 */
	...
	/**
	 * Registers this externalizable so readObject will be able to load such
	 * objects
	 * 
	 * @param e
	...
	private static char[] toCharArray(String s) {
		// toCharArray should return a new array always, however some devices
		// might
		// suffer a bug that allows mutating a String (serious security hole in
		// the JVM)
	 ...
	 * 
	 * @param baseURL
	 *            a source URL whose properties should be used to construct the
	 *            actual URL
	 * @param relativeURL
	 *            relative address
	...
	/**
	 * Returns the URL's base path, which is the same as the path only without
	 * an ending file e.g.: http://domain.com/f/f.html would return as: /f/
	 * 
	 * @param url
	 *            absolute URL
	 * @return the path within the host
	...
	/**
	 * The read fully method from data input stream is very useful for all types
	 * of streams...
	 * 
	 * @param b
