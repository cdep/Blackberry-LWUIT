...
/**
 * Pluggable logging framework that allows a developer to log into storage using
 * the file connector API. It is highly recommended to use this class coupled
 * with Netbeans preprocessing tags to reduce its overhead completely in
 * runtime.
 * 
 * @author Shai Almog
 */
public class Log {
	...
	private boolean fileWriteEnabled = false;// System.getProperty("microedition.io.file.FileConnection.version")
												// != null;
	 ...
	 * 
	 * @param newInstance
	 *            the new instance for the Log object
	 */
	...
	/**
	 * Default println method invokes the print instance method, uses DEBUG
	 * level
	 * 
	 * @param text
	 *            the text to print
	...
	/**
	 * Logs an exception to the log, by default print is called with the
	 * exception details, on supported devices the stack trace is also
	...
	/**
	 * Default method for creating the output writer into which we write, this
	 * method creates a simple log file using the file connector
	 * 
	 * @return writer object
	 * @throws IOException
	 *             when thrown by the connector
	 */
	...
	/**
	 * Sets the logging level for printing log details, the lower the value the
	 * more verbose would the printouts be
	 * 
	 * @param level
	 *            one of DEBUG, INFO, WARNING, ERROR
	 */
	...
	/**
	 * Returns the contents of the log as a single long string to be displayed
	 * by the application any way it sees fit
	 * 
	...
	/**
	 * Indicates whether GCF's file writing should be used to generate the log
	 * file
	 * 
	 ...
	 * file
	 * 
	 * @param fileWriteEnabled
	 *            the fileWriteEnabled to set
	 */
