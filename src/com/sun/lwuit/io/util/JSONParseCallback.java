...
public interface JSONParseCallback {
	...
	/**
	 * Submits a token from the JSON data as a java string, this token is always
	 * a string value
	 */
	...
	/**
	 * This method is called when a string key/value pair is detected within the
	 * json it is essentially redundant when following string/numeric token.
	 * 
	 * @param key
	 *            the key
	 * @param value
