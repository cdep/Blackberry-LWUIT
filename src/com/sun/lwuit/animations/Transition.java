 ...
 * next. A transition can be installed on a {@link com.sun.lwuit.Form} object
 * using the in/out transitions, for ease of use
...
public abstract class Transition implements Animation {
	...
	/**
	 * Invoked by {@link com.sun.lwuit.Display} to set the source and
	 * destination forms. This method should not be invoked by developers.
	 * 
	 * @param source
	 *            the source form from which the transition originates
	 * @param destination
	 *            the destination form to which the transition will lead
	 */
	 ...
	 * starting. This may be null for the first form in the application
	 * 
	 ...
	 * 
	 * @param reverse
	 *            creates a new transition instance with "reverse" behavior
	 *            useful for signifying "back" operations
