 ...
 * M3G (JSR 184) support on the device in order to work properly. Currently none
 * of these transitions work with dialogs or any component type that is not a
 * form
 * 
 * @author Shai Almog
 */
public final class Transition3D extends Transition {
	...
	/**
	 * Allows performance/memory sensitive devices to define a maximum size for
	 * the texture thus increasing performance on the expense of quality.
	 * 
	 * @param size
	 */
	 ...
	 * @param rotateRight
	 *            indicates rotating towards the right side or the left side
	 *            true == right
	...
	/**
	 * Creates a rotation transition from the current form to the next dialog,
	 * in this rotation only the dialog will rotate and the form will remain
	 * static
	 * 
	 * @param duration
	 *            duration in milliseconds of the transition
	...
	/**
	 * Creates a rotation transition from the top to the bottom giving a feeling
	 * of Swinging into place
	 * 
	 * @param duration
	 *            duration in milliseconds of the transition
