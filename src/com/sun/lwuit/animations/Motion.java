...
public class Motion {
	 ...
	 * 
	 * @param sourceValue
	 *            the number from which we are starting (usually indicating
	 *            animation start position)
	 * @param destinationValue
	 *            the number to which we are heading (usually indicating
	 *            animation destination)
	 * @param duration
	 *            the length in milliseconds of the motion (time it takes to get
	 *            from sourceValue to destinationValue)
	...
	public void setCurrentMotionTime(long currentMotionTime) {
		...
		// workaround allowing the motion to be restarted when manually setting
		// the current time
	 ...
	 * 
	 * @return true if System.currentTimeMillis() > duration + startTime or the
	 *         last returned value is the destination value
	 */
	...
	/**
	 * Returns the value for the motion for the current clock time. The value is
	 * dependent on the Motion type.
	 * 
