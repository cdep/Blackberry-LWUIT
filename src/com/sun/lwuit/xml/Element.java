...
/**
 * The Element class defines a single XML element with its attributes and
...
public class Element {
	...
	/**
	 * Constructs an Element (or a text element) with the specified name or
	 * text.
	 * 
	 * @param tagName
	 *            The tag name, or in the case of a text element the element's
	 *            text
	 * @param isTextElement
	 ...
	 * for the Element and has a valid value. This method allows creating a key
	 * that is non-string to be used by subclasses that optimize attributes
	 * retrieval
	 * 
	 * @param id
	 *            The attribute ID
	...
	/**
	 * Adds the specified Element as a child to this element. If the specified
	 * element was found to be unsupported (i.e. it's ID is TAG_UNSUPPORTED, it
	 * is not added.
	 * 
	 * @param childElement
	 *            The child element
	 ...
	 * @return true if this element contains the specified element, false
	 *         otherwise
	 */
	 ...
	 * @param name
	 *            The attribute id
	 * @return the attribute value by its name (or null if it wasn't defined for
	 *         this element)
	 */
	 ...
	 * @return The child position, or -1 if the child does not belong to this
	 *         element.
	 */
	 ...
	 * 
	 * @param oldChild
	 *            The child to replace (Must belong to this element, otherwise a
