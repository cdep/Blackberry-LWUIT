...
/**
 * Allows displaying labels and images with different alignment options, this
 * class is a base class for several components allowing them to declare
 * alignement/icon look in a similar way.
 * 
...
public class Label extends Component {
	...
	void initComponentImpl() {
		...
		// solves the case of a user starting a ticker before adding the
		// component
		// into the container
	...
	/**
	 * Sets the Label icon, if the icon is unmodified a repaint would not be
	 * triggered
	 * 
	 * @param icon
	 *            the image that the label presents.
	...
	/**
	 * Returns the vertical alignment of the Label, this will only work when the
	 * icon is in the side of the text and not above or bellow it.
	 * 
