...
public class EncodedImage extends Image {
	 ...
	 * 
	 * @param width
	 *            -1 if unknown ideally the width/height should be known in
	 *            advance
	 * @param height
	 *            -1 if unknown ideally the width/height should be known in
	 *            advance
	...
	/**
	 * A subclass might choose to load asynchroniously and reset the cache when
	 * the image is ready.
	 */
	 ...
	 * will be cached in a weak/soft reference internally. This method is useful
	 * to detect when the system actually created an image instance. You
	 * shouldn't invoke this method manually!
	 * 
