...
public class Effects {
	 ...
	 *            image to add the reflection effect to
	 * @param mirrorRatio
	 *            generally less than 1, a mirror ration of 0.5f will create a
	 *            mirror image half the height of the image, 0.75f will create a
	 *            3 quarter height mirror etc.
	 * @param alphaRatio
	 *            starting point for the alpha value in the mirror, this should
	 *            be a number between 0 - 255 (recommended larger than 0)
	 *            indicating the opacity of the closest pixel. For a mirror
	 *            thats completely opaque use 255. A recommended value would be
	 *            between 128 to 90.
	 * @return new image with a reflection effect for the source image
	 */
	...
	/**
	 * Grows or shrinks the given component to its new preferred size, this
	 * method essentially takes a component whose preferred size has changed and
	 ...
	 * 
	 * @param c
	 *            the component to grow/shrink, its size must be different from
	 *            its preferred size
	 * @param duration
