...
/**
 * Button is the base class for several UI widgets allowing clickability. It has
 * 3 states: rollover, pressed and the default state it can also have
 * ActionListeners that react when the Button is clicked.
 * 
 * @author Chen Fishbein
 */
public class Button extends Label {
	/**
	 * Indicates the rollover state of a button which is equivalent to focused
	 * for most uses
	 */
	 ...
	 * 
	 * @param x
	 *            the x position if a touch event triggered this, -1 if this
	 *            isn't relevant
	 * @param y
	 *            the y position if a touch event triggered this, -1 if this
	 *            isn't relevant
	 */
	...
	boolean isPressedStyle() {
		// if a toggle button has focus we should draw the selected state not
		// the pressed state
		// however if shouldRenderSelection is false the selected state won't be
		// painted so
	...
	/**
	 * Returns true if the button is selected for toggle buttons, throws an
	 * exception if this is not a toggle button
	 * 
	...
	/**
	 * Toggle button mode is only relevant for checkboxes/radio buttons. When
	 * pressed a toggle button stays pressed and when pressed again it moves to
	 * releleased state.
	 * 
	 * @return the toggle
	 */
	 ...
	 * Toggle button mode is only relevant for checkboxes/radio buttons. When
	 * pressed a toggle button stays pressed and when pressed again it moves to
	 * releleased state. Setting toggle implicitly changes the UIID to
	 * "ToggleButton"
	 * 
	 * @param toggle
	 *            the toggle to set
