...
/**
 * Implements touch functionality related code for compatibility with older BB
 * models
 * 
...
class BlackBerryTouchSupport extends BlackBerryCanvas {
	...
	public void paint(Graphics g) {
		super.paint(g);
		/*
		 * if(drawHover) { g.setColor(0xff); g.setGlobalAlpha(100);
		 * g.fillEllipse(hoverX, hoverY, hoverX + 20, hoverY, hoverX, hoverY +
		 * 20, 0, 360); g.setColor(0); g.setGlobalAlpha(255); }
		 */
	}
