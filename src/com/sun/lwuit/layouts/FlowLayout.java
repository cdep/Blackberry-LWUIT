...
public class FlowLayout extends Layout {
	...
	/**
	 * Indicates whether the layout manager should try to fill up the available
	 * space in the row
	 * 
	 * @return the fillRows
	 */
	 ...
	 * within the container will be aligned vertically to each other in the same
	 * row) When set to false (which is default) vertical alignment relates to
	 * the alignment of this container in regards to external components
	 * 
	 * @param internal
