 ...
 * Unlike the regular LWUIT bg painter, this also adds the following: - Painting
 * both a background color and a background image - Tiling horizontally or
 * vertically (or both) - Background image position offset horizontal and
 * vertical
 * 
 * @author Ofir Leitner
 */
class CSSBgPainter implements Painter {
	 ...
	 * 
	 * @param property
	 *            CSSElement.CSS_BACKGROUND_POSITION_X or Y for
	 *            horizontal/vertical
	 * @param pos
	 *            The position as a CSS length value
	 */
	 ...
	 * 
	 * @param pos
	 *            The position either in pixels or percentage
	 * @param isPercentage
	 *            if true then the numeric value give at 'pos' is actually
	 *            percentages
	 */
	...
	/**
	 * Sets this background to be fixed, which means it isn't affected by
	 * scrolling, but stays fixed in the back of the component it is applied on.
	 */
	void setFixed() {
		fixed = true;
	}
	 ...
	 * scrollable. This was copied from Container.getScrollableParent (Which
	 * can't be used as it is private)
	 * 
	...
	/**
	 * Calculates the starting drawing position for a certain dimension
	 * (horizontal/vertical) considering the given offset
	 * 
	 * @param offset
	 *            The offset in the dimension
	 * @param imageDim
	 *            The image dimension (width/height)
	 * @return The starting drawing position - 0 is the offset is 0 or a
	 *         negative value if there is an offset
	 */
