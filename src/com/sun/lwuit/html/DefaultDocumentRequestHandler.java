...
/**
 * Default implementation of the HTML components document request handler to
 * allow simple HTML support in LWUIT. This version includes only the basics
 * supported by MIDP e.g. resources and jar file URL's such as jar:// and res://
 * 
 * @author Shai Almog
 */
public class DefaultDocumentRequestHandler implements AsyncDocumentRequestHandler {
	...
	/**
	 * Allows URL's referring to a local:// local resource to default to this
	 * file
	 * 
	 * @param res
	 *            the resource
