...
public class TabbedPane extends Container {
	...
	public boolean animate() {
		// we track changes to the list and repaint when the list is scrolled so
		// the border paints correctly
	...
	/**
	 * Indicates the transition to use when switching between tabs from right to
	 * left.
	 * 
	 * @param transitionLeft
	 *            transition to use when switching tabs or null to avoid
	 *            transition
	 */
	...
	/**
	 * Indicates the transition to use when switching between tabs from left to
	 * right.
	 * 
	 * @param transitionRight
	 *            transition to use when switching tabs or null to avoid
	 *            transition
	 */
	 ...
	 * 
	 * @param listener
	 *            a selection listener to gets the selection events
	 */
	 ...
	 * tab and is recommended for performance reasons. You should invoke it with
	 * a String representing the width/height which will be used to calculate
	 * the size required for each element in the list.\
	 * <p>
	 * This operation is not essential and if it isn't invoked the size of the
	 * first few tabs is used to determine the overall size of a tab.
	 * <p>
	 * This allows the size calculations to work across look and feels and
	 * allows developers to predetermin size for the tabs.
	 * <p>
	 * e.g. For tabs which you would like to always be 5 characters wide you can
	 * use a prototype "XXXXX" which would use the preferred size of the XXXXX
	 * String to determine the size of the tabs..
	 * 
	 * @param title
	 *            a string to determine the size.
	 */
	 ...
	 * 
	 * @param tabbedPaneBorderWidth
	 *            TabbedPane surrounded border width
	 */
