...
/**
 * Central point singleton managing the look of the application, this class
 * allows us to customize the styles (themes) as well as the look instance.
 * 
...
public class UIManager {
	...
	/**
	 * Useful for caching theme images so they are not loaded twice in case an
	 * image reference is used it two places in the theme (e.g. same background
	...
	/**
	 * Returns the style of the component with the given id or a <b>new
	 * instance</b> of the default style. This method will always return a new
	 * style instance to prevent modification of the global style object.
	 * 
	 * @param id
	...
	/**
	 * Returns the selected style of the component with the given id or a <b>new
	 * instance</b> of the default style. This method will always return a new
	 * style instance to prevent modification of the global style object.
	 * 
	 * @param id
	...
	/**
	 * Returns a custom style for the component with the given id, this method
	 * always returns a new instance. Custom styles allow us to install
	 * application specific or component specific style attributes such as
	 * pressed, disabled, hover etc.
	 * 
	 * @param id
	...
	private Style getComponentStyleImpl(String id, boolean selected, String prefix) {
		try {
			...
			// fail gracefully for an illegal style, this is useful for the
			// resource editor
			err.printStackTrace();
	 ...
	 *            the theme to be installed or null, this is used to check if
	 *            style inheritance is used in which case we must NOT init style
	 *            defaults for that particular component
	 */
	 ...
	 * @param def
	 *            default value
	 * @return the value of the constant or the default if the constant isn't in
	 *         the theme
	 */
	 ...
	 * @param constantName
	 *            the name of the constant
	 * @return the value of the constant or null if the constant isn't in the
	 *         theme
	 */
	...
	private void buildTheme(Hashtable themeProps) {
		...
		// necessary to clear up the style so we don't get resedue from the
		// previous UI
		...
		if (themeProps != null) {
			...
			if (bgImage != null) {
				...
				if (bgImage instanceof String) {
					...
					// we shouldn't normally but we might get a multi-image from
					// the resource editor
	 ...
	 * exists in the resource bundle. If no key exists in the bundle then or a
	 * bundle is not installed the default value is returned.
	 * 
	 * @param key
	...
	/**
	 * Adds a Theme refresh listener. The listenres will get a callback when
	 * setThemeProps method is invoked.
	 * 
	 * @param l
