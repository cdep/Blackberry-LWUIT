...
public abstract class LookAndFeel {
	...
	/**
	 * Tint color is set when a form is partially covered be it by a menu or by
	 * a dialog. A look and feel can override this default value.
	 */
	...
	/**
	 * This member allows us to define a default animation that will draw the
	 * transition for entering a form
	 */
	private Transition defaultFormTransitionIn;
	/**
	 * This member allows us to define a default animation that will draw the
	 * transition for exiting a form
	 */
	private Transition defaultFormTransitionOut;
	/**
	 * This member allows us to define a default animation that will draw the
	 * transition for entering a menu
	 */
	private Transition defaultMenuTransitionIn;
	/**
	 * This member allows us to define a default animation that will draw the
	 * transition for exiting a menu
	 */
	private Transition defaultMenuTransitionOut;
	/**
	 * This member allows us to define a default animation that will draw the
	 * transition for entering a dialog
	 */
	...
	/**
	 * Indicates whether lists and containers should scroll only via focus and
	 * thus "jump" when moving to a larger component as was the case in older
	 * versions of LWUIT.
	 */
	...
	/**
	 * Allows defining a tactile touch device that vibrates when the user
	 * presses a component that should respond with tactile feedback on a touch
	 * device (e.g. vibrate). Setting this to 0 disables tactile feedback
	 * completely
	 */
	...
	/**
	 * Invoked when a look and feel is removed, allows a look and feel to
	 * release resources related to binding components.
	 * 
	 * @see #bind(Component)
	 */
	...
	/**
	 * Draws the text field without its cursor which is drawn in a separate
	 * method input mode indication can also be drawn using this method.
	 * 
	 * @param g
	 *            graphics context
	 * @param ta
	...
	/**
	 * Draws the cursor of the text field, blinking is handled simply by
	 * avoiding a call to this method.
	 * 
	 * @param g
	 *            graphics context
	 * @param ta
	 ...
	 *            graphics context
	 * @param c
	 *            component to draw on
	 * @param offsetRatio
	 *            ratio of the scroll bar from 0 to 1
	 * @param blockSizeRatio
	 *            block size for the scroll from 0 to 1
	 */
	public void drawVerticalScroll(Graphics g, Component c, float offsetRatio, float blockSizeRatio) {
		...
		if (fadeScrollEdge) {
			...
			if (offsetRatio < 1 - blockSizeRatio) {
				// special case since when scrolling with the physical keys we
				// leave
	...
	/**
	 * Sets the foreground color and font for a generic component, reuse-able by
	 * most component drawing code
	 * 
	 * @param g
	 *            graphics context
	 * @param c
	 *            component from which fg styles should be set
	 */
	...
	/**
	 * Draws and return the TabbedPane cell component (renderer) according to
	 * each tab orientation, the borders are getting draws
	 * 
	 * @param tp
	 *            the TabbedPane
	 * @param text
	 ...
	 *            the cell icon image
	 * @param isSelected
	 *            is the cell is the selected one
	 * @param cellHasFocus
	 *            is the cell has focus
	 * @param cellStyle
	 *            the cell Style object
	 * @param cellSelectedStyle
	 *            the selected style for the cell object
	 * @param tabbedPaneStyle
	 *            the TabbedPane Style object
	 * @param cellOffsetX
	 *            the offset when the cell is on TOP or BOTTOM orientation
	 * @param cellOffsetY
	 *            the offset when the cell is on LEFT or RIGHT orientation
	 * @param cellsPreferredSize
	 *            the total cells PreferredSize
	 * @param contentPaneSize
	 *            the contentPaneSize
	 ...
	 *            the TabbedPane
	 * @param g
	 *            the content pane graphics
	 * @param rect
	 *            the content pane painting rectangle area
	 * @param cellsPreferredSize
	 *            the total cells PreferredSize
	 * @param numOfTabs
	 *            number of tabs
	 ...
	 * exiting a form
	 * 
	 * @param defaultFormTransitionOut
	 *            the default transition
	 */
	 ...
	 * exiting a Menu
	 * 
	 * @param defaultMenuTransitionOut
	 *            the default transition
	 */
	 ...
	 * entering a dialog
	 * 
	 * @param defaultDialogTransitionIn
	 *            the default transition
	 */
	 ...
	 * exiting a dialog
	 * 
	 * @param defaultDialogTransitionOut
	 *            the default transition
	 */
	 ...
	 * Indicates the default speed for smooth scrolling
	 * 
	 * @param defaultSmoothScrollingSpeed
	 ...
	 * 
	 * @param touchMenus
	 *            true to enable touch menus false to disable
	 * @deprecated use
	 ...
	 * Indicates whether labels should end with 3 points by default
	 * 
	 * @param defaultEndsWith3Points
	 *            True to indicates that labels should end with 3 points by
	 *            default
	 */
	 ...
	 * Indicates whether tensile drag should be active by default
	 * 
	 * @param defaultTensileDrag
	 *            true if tensile drag should be active by default
	 */
	 ...
	 * The color of the text field cursor
	 * 
	 * @param textFieldCursorColor
	 *            the textFieldCursorColor to set
	 */
	 ...
	 * location in a grid
	 * 
	 * @param defaultSnapToGrid
	 *            the defaultSnapToGrid to set
	 */
	 ...
	 * scroll showable (scrollable flag still needs to be set to true)
	 * 
	 * @param defaultAlwaysTensile
	 *            the defaultAlwaysTensile to set
	 */
	 ...
	 * 
	 * @param g
	 *            graphics destination for the tensile highlight image
	 * @param top
	 *            destination of the tensile highlight image
	 * @param opacity
