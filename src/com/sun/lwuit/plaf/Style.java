 ...
 * and padding &amp; images.
 * <p>
 * Each Component contains a Style Object and allows Style modification in
 * Runtime by Using {@code cmp.getStyle()} The style is also used in Themeing,
 * when a Theme is Changed the Styles Objects are been updated automatically.
 * <p>
 * When changing a theme the elements changed manually in a style will not be
 * updated by the theme change by default. There are two ways to change that
 * behavior:
 * <ol>
 * <li>Use the set method that accepts a second boolean argument and set it to
 * true.
 * <li>Create a new style object and pass all the options in the constructor
 * (without invoking setters manually).
 * </ol>
 * <p>
 * The Margin and Padding is inspired by <a
 * href="http://www.w3.org/TR/REC-CSS2/box.html">W3 Box Model</a>
 * 
 * <pre>
 * 
 *       **************************
...
public class Style {
	...
	/**
	 * Indicates the background for the style would use a tiled image on both
	 * axis
	 */
	...
	/**
	 * Indicates the background for the style would use an unscaled image with
	 * an alignment
	 */
	...
	/**
	 * Indicates the unit type for padding/margin, the default is in device
	 * specific pixels
	 */
	public static final byte UNIT_TYPE_PIXELS = 0;

	/**
	 * Indicates the unit type for padding/margin in percentage of the size of
	 * the screen
	 */
	 ...
	 * Device independent pixels try to aim at roghly 1 milimeter of the screen
	 * per DIP but make no guarantee for accuracy.
	 */
	...
	/**
	 * Indicates the units used for padding elements, if null pixels are used if
	 * not this is a 4 element array containing values of UNIT_TYPE_PIXELS,
	 * UNIT_TYPE_DIPS or UNIT_TYPE_SCREEN_PERCENTAGE
	 */
	private byte[] paddingUnit;

	/**
	 * Indicates the units used for margin elements, if null pixels are used if
	 * not this is a 4 element array containing values of UNIT_TYPE_PIXELS,
	 * UNIT_TYPE_DIPS or UNIT_TYPE_SCREEN_PERCENTAGE
	 */
	...
	private int textDecoration; // Used for underline, strikethru etc. (See
								// TEXT_DECORATION_* constants)

	/**
	 * The modified flag indicates which portions of the style have changed
	 * using bitmask values
	 */
	...
	/**
	 * Each component when it draw itself uses this Object to determine in what
	 * colors it should use. When a Component is generated it construct a
	 * default Style Object. The Default values for each Component can be
	 * changed by using the UIManager class
	 */
	public Style() {
		setPadding(3, 3, 3, 3);
		setMargin(2, 2, 2, 2);
	...
	/**
	 * Creates a full copy of the given style. Notice that if the original style
	 * was modified manually (by invoking setters on it) it would not chnage
	 * when changing a theme/look and feel, however this newly created style
	 ...
	 * @param bgColor
	 *            background color
	 * @param fgSelectionColor
	 *            foreground selection color
	 * @param bgSelectionColor
	 ...
	 *            background image
	 * @param scaledImage
	 *            whether the image should be scaled or tiled
	 */
	 ...
	 *            BACKGROUND_IMAGE_TILE_HORIZONTAL, BACKGROUND_IMAGE_ALIGNED,
	...
	/**
	 * Returns true if the style was modified manually after it was created by
	 * the look and feel. If the style was modified manually (by one of the set
	 * methods) then it should be merged rather than overwritten.
	 * 
	 ...
	 * 
	 * @return one of: BACKGROUND_IMAGE_SCALED, BACKGROUND_IMAGE_TILE_BOTH,
	 ...
	 * 
	 * @return one of: BACKGROUND_IMAGE_ALIGN_TOP,
	 *         BACKGROUND_IMAGE_ALIGN_BOTTOM, BACKGROUND_IMAGE_ALIGN_LEFT,
	 *         BACKGROUND_IMAGE_ALIGN_RIGHT, BACKGROUND_IMAGE_ALIGN_CENTER
	 * @deprecated the functionality of this method is now covered by background
	 *             type
	 */
	 ...
	 * 
	 * @return value between 0 and 1 with 0.5 representing the center of the
	 *         component
	 */
	 ...
	 *            alignment value
	 * @param override
	 *            If set to true allows the look and feel/theme to override the
	 *            value in this attribute when changing a theme/look and feel
	 * @see com.sun.lwuit.Component#CENTER
	 * @see com.sun.lwuit.Component#LEFT
	 * @see com.sun.lwuit.Component#RIGHT
	 */
	 ...
	 * 
	 * @param backgroundAlignment
	 *            one of: BACKGROUND_IMAGE_ALIGN_TOP,
	 *            BACKGROUND_IMAGE_ALIGN_BOTTOM, BACKGROUND_IMAGE_ALIGN_LEFT,
	 *            BACKGROUND_IMAGE_ALIGN_RIGHT, BACKGROUND_IMAGE_ALIGN_CENTER
	 * @deprecated the functionality of this method is now covered by background
	 *             type
	 ...
	 * Sets the background color for the component
	 * 
	 * @param backgroundGradientStartColor
	 ...
	 * Sets the background color for the component
	 * 
	 * @param backgroundGradientEndColor
	 ...
	 * Background radial gradient relative center position X
	 * 
	 * @param backgroundGradientRelativeX
	 ...
	 * Background radial gradient relative center position Y
	 * 
	 * @param backgroundGradientRelativeY
	 ...
	 * Background radial gradient relative size
	 * 
	 * @param backgroundGradientRelativeSize
	 ...
	 * 
	 * @return the text decoration of this style (bitmask of the
	 *         TEXT_DECORATION_* constants)
	 */
	 ...
	 *            the textDecoration to set (bitmask of the TEXT_DECORATION_*
	 *            constants)
	 */
	...
	/**
	 * Returns the transparency (opacity) level of the Component, zero indicates
	...
	/**
	 * Sets the Component transparency (opacity) level of the Component, zero
	 * indicates fully transparent and FF indicates fully opaque.
	 * 
	 * @param transparency
	...
	/**
	 * Sets the Component transparency level. Valid values should be a number
	 * between 0-255
	 * 
	 * @param transparency
	 ...
	 * 
	 * @param orientation
	 *            one of: Component.TOP, Component.BOTTOM, Component.LEFT,
	 *            Component.RIGHT
	 * @param gap
	 *            number of pixels to padd
	 */
	 ...
	 * 
	 * @param rtl
	 *            flag indicating whether the padding is for an RTL bidi
	 *            component
	 * @param orientation
	 *            one of: Component.TOP, Component.BOTTOM, Component.LEFT,
	 *            Component.RIGHT
	 ...
	 * 
	 * @param backgroundGradientRelativeSize
	 *            the size of the radial gradient relative to the screens larger
	 *            dimension
	 * @param override
	 *            If set to true allows the look and feel/theme to override the
	 *            value in this attribute when changing a theme/look and feel
	...
	/**
	 * Return the background painter for this style, normally this would be the
	 * internal image/color painter but can be user defined
	 * 
	...
	/**
	 * Defines the background painter for this style, normally this would be the
	 * internal image/color painter but can be user defined
	 * 
	 * @param bgPainter
