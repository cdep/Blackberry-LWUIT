...
/**
 * A combo box is a list that allows only one selection at a time, when a user
 * clicks the combo box a popup button with the full list of elements allows the
 * selection of a single element. The combo box is driven by the list model and
 * allows all the renderer features of the List as well.
 * 
 * @see List
...
public class ComboBox extends List {
	...
	/**
	 * When this flag is active the combo box acts as a button that opens a
	 * dialog that looks like a spinner this allows creating user interfaces for
	 * touch devices where a spinner UI approach is more common than a combo box
	 * paradigm.
	 * 
	 ...
	 * paradigm.
	 * 
	 * @param aDefaultActAsSpinnerDialog
	...
	/**
	 * Indicates whethe the soft buttons for select/cancel should appear for the
	...
	/**
	 * Shows the popup dialog for the combo box and returns the resulting
	 * command. This method can be overriden by subclasses to modify the
	...
	/**
	 * Creates the list object used within the popup dialog. This method allows
	 * subclasses to customize the list creation for the popup dialog shown when
	 * the combo box is pressed.
	 * 
	 * @return a newly created list object used when the user presses the combo
	 *         box.
	 */
	 ...
	 * combo box
	 * 
	 * @return true if the soft buttons for select/cancel should appear for the
	 *         combo box
	 */
	 ...
	 * combo box by default
	 * 
	 * @param aDefaultIncludeSelectCancel
	 *            the new value
	 */
