 ...
 * HTMLComponent which provides a lightweight 100% cross platform web component.
 * This component will only work on platforms that support embedding a native
 * browser which exclude earlier versions of Blackberry devices and J2ME
 * devices.<br>
 ...
 * rather than LWUIT making that decision for it.
 * 
 * @author Shai Almog
 */
public class BrowserComponent extends Container {
	...
	/**
	 * This constructor will work as expected when a browser component is
	 * supported, see isNativeBrowserSupported()
	 */
	 ...
	 * platform specific but some must be fired for all platforms and will
	 * invoke the action listener when the appropriate event loads
	 * 
	 * @param type
	 *            platform specific but must support: onLoad, onError
	 * @param listener
